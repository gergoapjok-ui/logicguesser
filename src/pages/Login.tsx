      ...
      <div className="flex items-center justify-center min-h-screen pt-16 px-4">
        ...
        >
          <div className="glass rounded-2xl border border-border/50 p-8">
            ...
            <Button variant="outline" size="lg" className="w-full font-body" onClick={handleGoogleLogin}>
            ...
            <Button variant="outline" size="lg" className="w-full font-body" onClick={handleAppleLogin}>
