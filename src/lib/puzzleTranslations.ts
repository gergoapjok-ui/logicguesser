...
const templates: Record<string, Record<PuzzleLang, string>> = {
  ...
  "what_color_replace": { en: "What color should replace the \"?\" (purple, cyan, or yellow)?", hu: "Milyen színnel kell helyettesíteni a \"?\"-et? (lila, cián, sárga)", la: "Quem colorem debet substituere \"?\"? (purpureus, cyaneus, flavus)", el: "Ποιο χρώμα πρέπει να αντικαταστήσει το \"?\"; (μοβ, κυανό, κίτρινο)", zh: "应该用什么颜色替换"？"？(紫色、青色、黄色)" },
